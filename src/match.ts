...
export type TextMatcher = {
  ...
  readonly type: 'text'
  readonly value?: string | RegExp | undefined
}
...
function textMatcher(): TextMatcher
function textMatcher(value: string | RegExp): TextMatcher
function textMatcher(value?: string | RegExp): TextMatcher {
  return { [__linebotHonoTextMatcherBrand]: true, type: 'text', value } as const
}
